...
const RAW_ALIASES: Readonly<Record<HrImportColumnKey, readonly string[]>> = {
  ...
  neutralizeNineBoxEffect: [
    ...
    "neutraliser effet 9 box",
    "neutraliser l'effet 9-box",
    "neutraliser l effet 9-box",
    "neutraliser 9-box",
    "neutraliser 9 box",
    "effet 9-box neutralisé",
    "effet 9 box neutralise",
    "neutralize nine box",
    "neutralize nine-box",
    "neutralize 9-box effect",
    "neutralize 9 box effect",
    "neutralize nine box effect",
    "nine box neutralize",
    "9-box neutralize",
  ],
  promotionAmount: [
  ...
  salaryBeforePromotion: [
    ...
    "salaire de base avant promotion",
    "salary before promotion",
    "base salary before promotion",
  ],
  salaryAfterPromotion: [
    "salaire après promotion",
    "salaire apres promotion",
    "salaire de base après promotion",
    "salaire de base apres promotion",
    "salaire promu",
    "salary after promotion",
    "promoted salary",
    "base salary after promotion",
  ],
  previousGradeCode: [
    "ancien grade",
    "grade avant promotion",
    "previous grade",
  ...
  previousJobFamilyCode: [
    "ancienne famille",
    "ancienne famille de métiers",
    "ancienne famille de metiers",
    "famille avant promotion",
    "previous job family",
    "job family before promotion",
  ],
  promotedJobFamilyCode: [
    "nouvelle famille",
    "nouvelle famille de métiers",
    "nouvelle famille de metiers",
    "famille après promotion",
    "famille apres promotion",
    "promoted job family",
    "new job family",
    "job family after promotion",
  ],
};
